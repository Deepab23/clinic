...
class SectionController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Section']))
		{
            ...
            $fileName = "category".time().".".$uploadedFile->getExtensionName(); 
            $model->Video = $fileName; 

			if($model->save()){
				
			    $uploadedFile->saveAs(Yii::app()->basePath.'/../uploads/images/' .$fileName);  // Image will uplode to rootDirectory/banner/
				$this->redirect('index');
			}
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Section']))
		{
			$_POST['Section']['Video']=$modeld->Video;
			$model->attributes=$_POST['Section'];
