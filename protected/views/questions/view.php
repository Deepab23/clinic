...
<div style="margin: 10px auto;width: 700px;">
			...
			$criteria=new CDbCriteria;
					...
					foreach($steps as $step){
						...
						<h3><?php echo $step->Title ?>  <a style="margin-left: 90px;font-size:13px;" onclick="doredirects('<?php echo $step->Id; ?>')"> Click here to edit this section </a> </h3>
...
<div>
<a class="btn btn-blue" href="<?php echo Yii::app()->request->baseUrl; ?>/project"> GO BACK </a>
</div>		
<div>
